...
def validate_address(address):
    # Verifica se o endereco tem algum caracter.
...
def process_csv(csv_filepath, db_filepath):
    ...
    with open(csv_filepath, 'r') as file:
        ...
        for row in reader:
            ...
            if ' ' not in name:
                print(f"Nome invalido: {name} (deve conter sobrenome)")
                continue
            ...
            if not validate_phone(phone):
                print(f"Telefone invalido: {phone}")
                continue

            if not validate_address(address):
                print(f"Endereco invalido: {address}")
                continue
...
Para deixar o programa digite 5:
""")
        answer = int(input())
        ...
        if answer == 1:
            ...
            while True:
                ...
                if not validate_phone(telefone_digitado):
                    ...
                    break
            while True:
                endereco_digitado = str(input("Digite o endereco: "))
            ...
            if input("Atualizar telefone? (s/n): ").lower() == 's':
                while True:
                    ...
                    if not validate_phone(telefone_digitado):
                        ...
                        break
            if input("Atualizar endereco? (s/n): ").lower() == 's':
                while True:
                    endereco_digitado = str(input("Digite o endereco: "))
                    if not validate_address(endereco_digitado):
                        print("Digite um endereço valido.")
